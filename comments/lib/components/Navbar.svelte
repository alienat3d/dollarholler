...
<button
  ...
  class="text-daisy-bush duration-1200 fixed top-6 right-6 z-navBarToggle cursor-pointer transition-colors md:hidden"
...
<header
  class="bg-daisy-bush duration-750 fixed z-navBar h-screen w-full -translate-x-full text-center transition-transform md:relative md:col-span-3 md:h-full md:translate-x-0"
...
<style>
  ...
  nav ul li a.active {
    padding-left: 32px;
    padding-right: 32px;
    background: url('/images/active-nav--left.svg') left bottom no-repeat,
