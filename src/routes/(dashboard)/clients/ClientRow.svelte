...
<div class="client-table client-row rounded-lg bg-white py-3 shadow-tableRow lg:py-6">
  ...
  <div class="received text-right font-mono text-sm font-bold lg:text-lg">$324.00</div>
  <div class="balance text-right font-mono text-sm font-bold text-scarlet lg:text-lg">$105.50</div>
